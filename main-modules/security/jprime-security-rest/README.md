...
### Права доступа к определенному объекту
...
### Массовое получение настроек доступа текущего пользователя к указанным объектам

``POST /access/v1/jpObjects/batchCheck``
...
| objectClassCode | Кодовое имя класса объекта          |
| objectIds       | Идентификаторы объектов класса      |
...
### Полный список настроек политик доступа ABAC
