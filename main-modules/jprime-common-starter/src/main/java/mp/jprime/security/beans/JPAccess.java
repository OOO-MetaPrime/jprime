...
public class JPAccess {
   ...
   * @param role   Роль
   */
  private JPAccess(boolean read, boolean create, boolean update, boolean delete, String role) {
    this.read = read;
    this.create = create;
    this.update = update;
    this.delete = delete;
  ...
  public static final class Builder {
     ...
     * @return JPAccess
     */
    public JPAccess build() {
      return new JPAccess(read, create, update, delete, role);
    }
