...
public final class JPAbacMemoryStorage implements JPAbacStorage {
   ...
   */
  private JPAbacDynamicLoader dynamicLoader;
  ...
  private JPAbacMemoryStorage(@Autowired JPAbacAnnoLoader annoLoader,
                              ...
                              @Autowired(required = false) JPAbacDynamicLoader dLoader) {
  ...
  private void setDynamicLoader(JPAbacDynamicLoader dynamicLoader) {
