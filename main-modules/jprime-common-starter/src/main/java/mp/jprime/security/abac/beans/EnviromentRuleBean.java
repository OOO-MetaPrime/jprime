 ...
 */
public class EnviromentRuleBean implements EnviromentRule {
  ...
  private EnviromentRuleBean(String name, String qName, JPAccessType effect,
  ...
  public static final class Builder {
    ...
    public EnviromentRuleBean build() {
      return new EnviromentRuleBean(name, qName, effect, daysOfWeek, fromTime, toTime, fromDateTime, toDateTime, ip);
    }
