...
import mp.jprime.security.services.JPAccessService;
...
public class JPFileCommonUploader implements JPFileUploader {
  ...
  // Проверка доступа
  private JPAccessService accessService;
  ...
  @Autowired
  private void setAccessService(JPAccessService accessService) {
  ...
  public JPCreate.Builder upload(JPCreate.Builder builder, String attr, String fileName, InputStream is) {
    return fileUpload(builder, attr, fileName, is, (jpClass, jpAttr) -> {
      ...
      JPResourceAccess access = authInfo != null ? accessService.checkRead(jpClass.getCode(), authInfo) : null;
  ...
  public JPUpdate.Builder upload(JPUpdate.Builder builder, String attr, String fileName, InputStream is) {
    return fileUpload(builder, attr, fileName, is, (jpClass, jpAttr) -> {
      ...
      JPResourceAccess access = authInfo != null ? accessService.checkUpdate(jpClass.getCode(), authInfo) : null;
      return (access == null || access.isAccess()) &&
