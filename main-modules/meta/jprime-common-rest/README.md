...
Для сложных условий рекомендуется использовать механизм доп. свойств, заранее определенных на беке и вызываемых по коду

Есть три типа дополнительных свойств:
...
{
    "cond": {
       "feature": "nonParticipantServiceOnDate",
       "checkDay": "2026-01-01"
    }
}
```
...
{
    "cond": {
       "feature": "nonParticipantServiceOnPeriod",
       "checkFromDay": "2026-01-01",
       "checkToDay": "2026-12-31"
    }
}
```

При использовании последних надо дополнительно указать даты проверки
