...
public final class JPTransactionEventManager implements TransactionEventManager, JPClassesLinkFilter<TransactionEventListener> {
  ...
  private final FluxSink<Collection<TransactionEvent>> sink;

  public JPTransactionEventManager() {
    FluxProcessor<Collection<TransactionEvent>, Collection<TransactionEvent>> processor = ReplayProcessor.<Collection<TransactionEvent>>create(1).serialize();
    this.sink = processor.sink();
    processor.subscribe(this::subscribeEvents);
  }
