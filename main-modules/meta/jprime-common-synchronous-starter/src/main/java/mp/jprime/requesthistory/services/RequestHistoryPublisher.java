...
public interface RequestHistoryPublisher {
   ...
   */
  void sendObject(AuthInfo auth, ServerWebExchange swe, String classCode, Object objectId, Supplier<RequestHistoryObject> result);
   ...
   */
  void sendSearch(AuthInfo auth, ServerWebExchange swe, String classCode, Supplier<Object> searchBody, Supplier<Collection<RequestHistoryObject>> results);
}
