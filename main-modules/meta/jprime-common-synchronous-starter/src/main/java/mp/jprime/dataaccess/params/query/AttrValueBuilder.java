...
import mp.jprime.dataaccess.params.query.filters.attr.array.OverlapsArray;
...
public final class AttrValueBuilder {
   ...
   */
  private AttrValueBuilder(String attrCode) {
   ...
   */
  public static AttrValueBuilder of(String attrCode) {
    return new AttrValueBuilder(attrCode);
  }
  ...
  public INQuery inQuery(JPSubQuery value) {
    return new INQuery(attrCode, value);
  }
  ...
  public NotINQuery notInQuery(JPSubQuery value) {
    return new NotINQuery(attrCode, value);
  }
