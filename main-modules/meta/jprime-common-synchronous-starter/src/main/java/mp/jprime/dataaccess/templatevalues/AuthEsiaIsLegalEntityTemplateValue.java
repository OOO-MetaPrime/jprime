...
/**
 * AUTH_ESIA_IS_LEGALENTITY - признак ФЛ
 */
@Service
public class AuthEsiaIsLegalEntityTemplateValue implements JPTemplateValue {

  @Override
  public String getTemplate() {
    return FilterValue.AUTH_ESIA_IS_LEGALENTITY_TEMPLATE;
  }
