 ...
 */
public class FuzzyOrderLike extends AttrValueFilter<String> {
  /**
   * Конструктор
   *
  ...
  @Override
  public FuzzyOrderLike ofAttr(String attrCode) {
    return new FuzzyOrderLike(attrCode, this.getValue());
  }
}
