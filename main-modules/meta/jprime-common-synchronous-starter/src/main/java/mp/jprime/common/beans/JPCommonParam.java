 ...
 */
public final class JPCommonParam implements JPParam {
  /**
   * Код
   */
   ...
   */
  private final JPIntegerFormat integerFormat;
  /**
   ...
   * @param integerFormat Тип целочисленного поля
   * @param multiline     Признак многострочного строкового поля
   ...
   * @param external      Возможность внешнего использования параметра
  ...
  @Override
  public JPIntegerFormat getIntegerFormat() {
  ...
  public static class Builder {
    ...
    protected JPIntegerFormat integerFormat;
    ...
    public Builder integerFormat(JPIntegerFormat integerFormat) {
      this.integerFormat = integerFormat;
      return this;
    }
