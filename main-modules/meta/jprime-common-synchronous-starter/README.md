...
* типовую логику
* базовое API 
* базовые реализации основных синхронных функций системы
* отправки синхронных REST-запросов (`JPRestTemplate`)
...
| actionLog   | Признак логирования при действии над объектами      |
...
| actionLog        | Признак логирования значения атрибута при действии над объектами   |
...
| startsWithIn    | Значение начинается с указанного в списке                   | -             | -          | -       | -    | -        | -      | -     | -       | -    | +      | -         | -    | -    | -     | -     |
| notStartsWithIn | Значение не начинается с указанного в списке                | -             | -          | -       | -    | -        | -      | -     | -       | -    | +      | -         | -    | -    | -     | -     |
...
Внимание: использовать `inQuery` и `notInQuery` можно только при небольших данных, так как в отличии от `exists` эти два условия делают отдельный запрос на получение значений указанного атрибута
...
Поддерживается два хранилища настроек
* Проектное `globalSettings`
* Глобальное `globalSettings-common` 

При этом, настройки `globalSettings-common` имеют приоритет при совпадении кодов
